...
self.addEventListener('install', e => {
  ...
  // addAll may take the browser's own copy of the very files it is meant to replace, which is how
  // a redrawn icon ends up cached as the old one all over again.
